  ...
  return (
    <div className="bg-[#302E2A] shadow-md">
      ...
      <div className="hidden md:block">
        ...
        {showSearchBar && (
          <div className="px-[9rem] pt-2 pb-4 animate-fadeIn border-t-2 border-[#e6d4a5]"> {/* Added border here */}
      ...
      <div className="md:hidden">
        ...
        {showSearchBar && (
          <div className="px-[0.2rem] pt-2 pb-4 animate-fadeIn border-t-2 border-[#e6d4a5]"> {/* Added border here */}
            <div className="relative">
              <input
                type="text"
                placeholder="COUPLE BRACELETS...."
