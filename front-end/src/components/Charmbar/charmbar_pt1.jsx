...
// PRODUCTS
const necklaces = [
  { img: product1, text: "Elegant Necklace", price: 29999 },
  { img: product2, text: "Classic Necklace", price: 24999 },
  { img: product3, text: "Charming Necklace", price: 19999 },
  { img: product4, text: "Stylish Necklace", price: 34999 },
  { img: product3, text: "Charming Necklace", price: 19999 },
];
            ...
            {necklaces.map((item, i) => (
              <div key={i} onClick={() => setBaseImage(item.img)} className="relative group min-w-[15rem] cursor-pointer hover:scale-105 transition-transform">
                ...
                <div className="absolute inset-0 bg-[#f5f5dc] opacity-0 group-hover:opacity-80 flex flex-col justify-center items-center transition-opacity">
                  ...
                  <span className="text-sm">Rp {formatIDR(item.price)}</span>
                </div>
              </div>
            ))}
          </div>
